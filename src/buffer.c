...
//
uint8_t buffer_get_uint8(BUFFER_HANDLE* buf) {
...
//
uint16_t buffer_get_uint16(BUFFER_HANDLE* buf, int32_t little_endian) {
...
//
uint32_t buffer_get_uint32(BUFFER_HANDLE* buf, int32_t little_endian) {
