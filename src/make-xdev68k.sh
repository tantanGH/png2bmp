...
TARGET_FILE="PNG2BMP.X"
DOC_FILE="../PNG2BMP.DOC"
ZIP_FILE="../../PNGBM010.ZIP"
...
INCLUDE_FLAGS="-I${XDEV68K_DIR}/include/xc -I${XDEV68K_DIR}/include/xdev68k -I${XDEV68K_DIR}/include/zlib"
...
function build_png2bmp() {
  do_compile . "himem buffer png_decode bmp_encode main"
  if [ $? != 0 ]; then
    return $?
  fi
  cd _build
